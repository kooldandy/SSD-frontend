...
type EditFormProps = Readonly<{
  ...
  saving: boolean
  status?: string | null
  onChange: (field: 'name' | 'description' | 'price' | 'quantity', value: string) => void
  onSave: () => void
  onCancel: () => void
}>

export default function ProductEditForm({ values, errors, saving, status, onChange, onSave, onCancel }: EditFormProps) {
  return (
